...
import '../lp-staking-model/lp-staking-modal.scss';

const AgovLpStackemodal = (props: any) => {
  return (
    <>
      <Modal
        {...props}
      ...
      >
        ...
        >
          ...
          <Button
            className="ready_btn"
            onClick={() => props.ReqpoolStaking('stakebtn', props.uniswapId, 0)}
          >
            {' '}
...
export default memo(AgovLpStackemodal);
