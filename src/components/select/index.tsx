...
function Select({
  ...
  useEffect(() => {
    if (selected) {
      selectValueChange && selectValueChange(selected);
          ...
          <>
            <div className="relative z-10">
              ...
              >
                <Listbox.Options
                  static
                  className="eth_option absolute w-full mt-1 overflow-auto text-18 text-white
                        ...
                        <div className="flex items-center space-x-2">
                          ...
                          <span
                            className={`${
                              ...
                              type === 'primary' ? 'text-16 text-fadeBlue2' : ''
                            }`}
                          >
                            {option.name}
                          </span>
